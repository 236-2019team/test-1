...
class TrailsTableViewController: UITableViewController, UISearchBarDelegate {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = data[indexPath.row].trailName
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        print("test")
        if let viewController = storyboard?.instantiateViewController(identifier: "TrailMapView") as? TrailMapView {
            viewController.selectedTrail = row
